...
<option value="Sistem Informasi" {{ old('prodi',$mhs->prodi)=='Sistem
Informasi' ? 'selected' : '' }}>Sistem Informasi</option>
<option value="Teknologi Komputer" {{ old('prodi',$mhs->prodi)=='Teknologi
Komputer' ? 'selected' : '' }}>Teknologi Komputer</option>
<option value="Sistem Informasi Akuntansi" {{ old('prodi',$mhs-
>prodi)=='Sistem Informasi Akuntansi' ? 'selected' : '' }}>Sistem Informasi
Akuntansi</option>
</select>
</div>
<div>
